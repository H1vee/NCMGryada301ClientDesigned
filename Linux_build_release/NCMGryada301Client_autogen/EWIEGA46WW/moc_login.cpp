...
template <> constexpr inline auto Login::qt_create_metaobjectdata<qt_meta_tag_ZN5LoginE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "OKButtonClick",
        "",
        "ShowOTPCheckBoxClick",
        "ShowPasswordCheckBoxClick"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'OKButtonClick'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'ShowOTPCheckBoxClick'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'ShowPasswordCheckBoxClick'
...
void Login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->ShowOTPCheckBoxClick(); break;
        case 2: _t->ShowPasswordCheckBoxClick(); break;
        default: ;
        }
    }
    (void)_a;
